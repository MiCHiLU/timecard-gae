...
abstract class Client extends ClientBase {
  core.String basePath = "/_ah/api/timecard/dev/";
  core.String rootUrl = "https://timecard-gae.appspot.com/";

  //
  // Resources
  //

  CommentResource_ get comment => new CommentResource_(this);
  IssueResource_ get issue => new IssueResource_(this);
  MeResource_ get me => new MeResource_(this);
  ProjectResource_ get project => new ProjectResource_(this);
  UserResource_ get user => new UserResource_(this);
  WorkloadResource_ get workload => new WorkloadResource_(this);
